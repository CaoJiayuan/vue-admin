...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_auth_Login_vue__ = __webpack_require__(20);
...
window.Vue.component('Login', __WEBPACK_IMPORTED_MODULE_0__components_auth_Login_vue___default.a);
var app = new Vue({
    el: '#app'
});
                  ...
                  change: function($event) {
                    ...
                    if (Array.isArray($$a)) {
                      var $$v = null,
                        $$i = _vm._i($$a, $$v)
                      if ($$el.checked) {
                        $$i < 0 && (_vm.user.remember = $$a.concat([$$v]))
                      } else {
                        $$i > -1 &&
                          (_vm.user.remember = $$a
                            .slice(0, $$i)
